  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> ABC </a>
            </li>
          </ul>
        </div>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Menu 1</p>

          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-700 transition hover:opacity-75"> Option A </a>
            </li>
          </ul>
        </div>

        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Menu 2</p>
        ...
        <div className="col-span-2 sm:col-span-1">
          <p className="font-medium text-gray-900">Menu 3</p>
    ...
    <div className="mt-8 border-t border-gray-100 pt-8">
      <div className="sm:flex sm:justify-between">
        <p className="text-xs text-gray-500">&copy; 2025. InnovationCenter. All rights reserved.</p>
